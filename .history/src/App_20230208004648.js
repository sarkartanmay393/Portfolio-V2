...
function App({ db }) {
  const [websiteData, setWebsiteData] = useState({
    ...
    funfact_highlights: ['momos', 'winter', 'summer', 'The Witcher', 'Naruto'],
    all_projects: {
      weeks_of_works: [
        {
          title: 'Yatra Sahayak',
          ...
          image:
            'https://github.com/sarkartanmay393/RoomReservation-Go/raw/main/static/readme/logo.png',
        ...
        },
        {
          ...
          image:
            'https://github.com/sarkartanmay393/Blog-Platform-Web3/raw/master/public/blogosphere-logo.png',
      ...
      days_of_works: [
        {
          ...
          url: 'https://github.com/sarkartanmay393/Gaze-Weather-JS',
          description:
            'Contains a weather interface with main stream informations about your location.',
        },
        {
    ...
    skills: {
      ...
      cloud: ['Linode', 'Civo', 'Firebase'],
      frameworks: ['React', 'Express', 'Flutter'],
      databases: ['MySQL', 'PostgreSQL', 'MongoDB', 'Redis'],
      languages: ['JavaScript', 'Go', 'Java', 'Dart'],
      others: ['Linux'],
    },
    projects: [
      {
        ...
        all_projects: {
          weeks_of_works: [
            ...
            },
            {
              ...
              madeby: 'ReactJS, HTML, CSS, RestAPI',
              description:
                'Contains Javascript code of a blogging website using ReactJS, HTML, CSS',
              title: 'Gaze Weather',
              url: 'https://github.com/sarkartanmay393/Gaze-Weather-JS',
            },
            {
          ...
          days_of_works: [
            {
              ...
              url: 'https://github.com/sarkartanmay393/Gaze-Weather-JS',
              description:
                'Contains a weather interface with main Contains a weather interface with main Contains a weather interface with main Contains a weather interface with main Contains a weather interface with main Contains a weather interface with main Contains a weather interface with main Contains a weather interface with main Contains a weather interface with main Contains a weather interface with main Contains a weather interface with main Contains a weather interface with main Contains a weather interface with main Contains a weather interface with main Contains a weather interface with main Contains a weather interface with main stream informations about your location.',
            },
            {
              title: 'Text Lead Tracker',
              madeby: 'HTML, CSS, JS',
              ...
              url: 'https://github.com/sarkartanmay393/TextLead-Tracker',
              description:
                'Contains raw HTML, CSS and JS code of a Chrome Extension to save quickies.',
            },
          ],
        },
      ...
      <main id='home'>
        <section className='main-components'>
          <Switch>
            ...
            <Route path='/projects'>
              <ProjectsPage
                weeksOfWork={websiteData.all_projects.weeks_of_works}
                daysOfWork={websiteData.all_projects.days_of_works}
              />
            </Route>
            <Route path='/about'>
              <AboutPage
